Project 1: Factorial Digits [FAC]
...
Input: user chooses integer n
, where 0≤n≤100
Output: integer x

, where x is the number of the zeros in n!
...
Extra Credit:  integer y
, where y is the sum of the digits in n!
